...
contract NativeToken721Market is 
    ...
    event ItemListed (
        uint itemId,
        address seller //TODO: Probably dont need
    );
    ...
    function listItem(
        ...
        _marketItems[itemId] = MarketItem(  //Just keeps track of sell info
            itemId,
            nftContract,
            tokenId,
            msg.sender,
        ...
        _activeIds.add(itemId);             //set of items for sale
        _usersTotalListings[msg.sender].add(itemId);    //set of user-specific items for sale
        _itemIds = itemId;
